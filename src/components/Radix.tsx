...
const TabsTriggerClassName = `px-4 py-1 text-sm font-medium text-neutral-900 data-[state=active]:bg-white
data-[state=active]:border-solid data-[state=active]:border-1px data-[state=active]:border-gray-300 border-transparent border-1px transition-all duration-100
